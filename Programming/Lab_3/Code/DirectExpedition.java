...
public class DirectExpedition extends Expedition implements Solvable, Delayable {
    private String name;
    private Place[] path;

    DirectExpedition(String name, Place end, Place... path) {
        this.name = name;
        this.endPoint = end;
        this.path = path;
    }

    DirectExpedition(String name) {
    ...
    public boolean equals(Object o) {
        ...
        DirectExpedition de = (DirectExpedition) o;
